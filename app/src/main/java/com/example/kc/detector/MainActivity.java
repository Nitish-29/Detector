package com.example.kc.detector;
...
import com.example.kc.detector.object_recog.ObjectRecognizer;
import com.example.kc.detector.object_recog.Utilities;
import com.example.kc.detector.object_recog.MatchingStrategy;
...
public class MainActivity extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (isSynthesizerInitialized) {
            if ((!detectedObj.equals("-")) && (!detectedObj.equals(lastDetectedObj)))
            {
